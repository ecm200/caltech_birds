...
from pytorchcv.utils import prepare_model as ptcv_prepare_model
...
model_ft = model_func(**model_args)

# Reconfigure FC classification layer for 200 classes
num_ftrs = model_ft.output.fc.in_features
# Here the size of each output sample is set to 2.
# Alternatively, it can be generalized to nn.Linear(num_ftrs, len(class_names)).
model_ft.output.fc = nn.Linear(num_ftrs, len(class_names))
