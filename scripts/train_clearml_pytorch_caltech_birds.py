...
task = Task.init(project_name='Caltech Birds', task_name='Train PyTorch CNN on CUB200 [Library: '+cfg.MODEL.MODEL_LIBRARY+', Network: '+cfg.MODEL.MODEL_NAME+']', task_type=Task.TaskTypes.training)
